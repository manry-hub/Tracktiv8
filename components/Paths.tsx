            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Choose from various industries and roles to get
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Menguasai pengembangan software dengan tech stack
                            javascript dalam sisi Front End maupun Back End
                        </p>
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            ...
                            Next.js dalam kurikulum AI-powered yang relevan
                            dengan industri.
                        </p>
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            ...
                            kurikulum AI-powered yang sesuai kebutuhan industri.
                        </p>
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Kuasai data analytics dari nol hingga mahir dengan
                            kurikulum AI-powered yang selaras dengan kebutuhan
                            industri.
                        </p>
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Belajar strategi digital marketing terkini dengan
                            kurikulum AI-powered yang relevan dengan industri.
                        </p>
